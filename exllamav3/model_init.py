...
def add_args(
    ...
    parser.add_argument("-tpb", "--tp_backend", type = str, help = "Tensor-parallel backend: 'native' (default), 'p2p' (native with direct GPU-to-GPU all-reduce, falls back to native if peer access is unavailable) or 'nccl'", default = "native")

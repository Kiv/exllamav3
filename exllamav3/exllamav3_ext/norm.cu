...
{
    rms_norm_row<res_mode, input_t, output_t, weight_t, residual_t>
        (x, w, y, r, epsilon, blockIdx.x, dim, constant_bias, constant_scale, w_groups);
}
...
)
{
    ...
    int threads = rms_norm_threads(dim);
